...
public class BrainFlowPlugin : ModuleRules
{
	public BrainFlowPlugin(ReadOnlyTargetRules Target) : base(Target)
	{
        ...
        {
            PublicSystemLibraryPaths.Add(Path.Combine(ModuleDirectory, "Compiled", "x64_dynamic", "lib"));
        ...
        {
            PublicSystemLibraryPaths.Add(Path.Combine(ModuleDirectory, "Compiled", "macos", "inc"));
            PublicSystemLibraryPaths.Add(Path.Combine(ModuleDirectory, "Compiled", "macos", "lib"));
        ...
        {
            PublicSystemLibraryPaths.Add(Path.Combine(ModuleDirectory, "Compiled", "linux", "inc"));
            PublicSystemLibraryPaths.Add(Path.Combine(ModuleDirectory, "Compiled", "linux", "lib"));
            PublicAdditionalLibraries.Add("libBrainflow.a");
